...
<?php
if (isset($_GET['id'])) {
 get_out_page("sliders", $_GET['id']);


 $edit_id = $_GET['id'];
 $query = query("SELECT * FROM sliders WHERE id = $edit_id");
 confirm($query);
...
<div class="head-title">
 <div class="left">
  ...
  <ul class="breadcrumb">
   ...
   <li>
    <a class="active" href="#">Edit Sliders</a>
   </li>
  </ul>
 </div>
 <div class="btn-div">
  <a href="admin.php?sliders" class="btn-download">
   <span class="text">See Sliders</span>
  </a>
 </div>
</div>
